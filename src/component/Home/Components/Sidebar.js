    ...
    return (
        ...
        <div className="sidebar-header flex items-center justify-center py-4">
          <div className="inline-flex">
            <div className="inline-flex flex-row items-center">
              ...
              <span className="leading-10 text-gray-100 text-2xl font-bold ml-1 uppercase">Universe App</span>
            </div>
          </div>
        </div>
        <div className="sidebar-content px-4 py-6">
          <ul className="flex flex-col w-full">
            ...
            <li className="my-px">
              <div className="flex flex-row items-center h-10 px-3 rounded-lg text-gray-300 hover:bg-gray-100 hover:text-gray-700">
                <span className="flex items-center justify-center text-lg text-gray-400">
                  <svg
                    fill="none"
                    strokeLinecap="round"
